...
""",
    ...
    def test_email_creates_plan_and_immutable_approval(self) -> None:
        ...
        self.assertIn("# Action Plan", plan_text)
        self.assertIn("## Recommended Action", plan_text)
        self.assertIn("| Priority | `medium` |", plan_text)
        self.assertIn("1. Confirm the purchase date and receipt.", plan_text)
